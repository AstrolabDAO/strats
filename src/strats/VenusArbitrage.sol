...
import "../external/Venus/IVenus.sol";
import {IPoolAddressesProvider, IAaveV3Pool} from "../external/Aave/v3/IAaveV3.sol";
...
contract VenusArbitrage is StrategyV5 {
  ...
  function _flashLoan(
    ...
    IAaveV3Pool(params.aavePoolProvider.getPool()).flashLoanSimple(
      address(this),
