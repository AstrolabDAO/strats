...
interface IAlpVault {
  ...
  event RewardDistributed(
    uint256 usdcRewards, uint256 toOwner, uint256 toWater, uint256 toAlpUsers
  );
...
interface IRumVault {
  ...
  event RequestedOpenPosition(
    address user, uint256 amount, uint256 timestamp, uint256 orderId
  );
  event OpenPositionCancelled(
    address user, uint256 amount, uint256 timestamp, uint256 orderId
  );
  ...
  event RequestedClosePosition(
    address user, uint256 amount, uint256 timestamp, uint256 orderId, uint32 positionId
  );
  event ClosePositionCancelled(
    address user, uint256 amount, uint256 timestamp, uint256 orderId, uint32 positionId
  );
  ...
  function getCurrentLeverageAmount(
    uint256 _positionID,
    address _user
...
interface IVodkaV1 {
  ...
  function closePosition(uint256 _positionID, address _user, bool _sameSwap) external;
