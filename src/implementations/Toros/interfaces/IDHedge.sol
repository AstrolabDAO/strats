...
interface IDhedgeEasySwapper {
    ...
    function setWithdrawProps(
        EasySwapperStructs.WithdrawProps calldata _withdrawProps
    ) external;

    function setSwapRouter(IUniswapV2RouterSwapOnly _swapRouter) external;
...
interface IDHedgePool {
    ...
    function tokenPriceWithoutManagerFee()
        external
        view
