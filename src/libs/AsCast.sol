...
library AsCast {
   ...
   * @param value The int256 to be downcasted
   * @return downcasted The downcasted int8 value
   ...
   * @param value The int256 to be downcasted
   * @return downcasted The downcasted int16 value
   ...
   * @param value The int256 to be downcasted
   * @return downcasted The downcasted int32 value
   ...
   * @param value The int256 to be downcasted
   * @return downcasted The downcasted int64 value
   ...
   * @param value The int256 to be downcasted
   * @return downcasted The downcasted int128 value
   ...
   * @param value The int256 to be downcasted
   * @return downcasted The downcasted int224 value
   ...
   * @param value The uint256 to be downcasted
   * @return downcasted The downcasted int256 value
  ...
  /**
   * @notice Convert an unsigned integer to an 8-bit unsigned integer
   * @dev Requires the input to be within the valid range for an 8-bit unsigned integer
   * @param x The input unsigned integer
   * @return The input value as an 8-bit unsigned integer
   */
  ...
  /**
   * @notice Convert an unsigned integer to a 16-bit unsigned integer
   * @dev Requires the input to be within the valid range for a 16-bit unsigned integer
   * @param x The input unsigned integer
   * @return The input value as a 16-bit unsigned integer
   */
  ...
  /**
   * @notice Convert an unsigned integer to a 64-bit unsigned integer
   * @dev Requires the input to be within the valid range for a 64-bit unsigned integer
   * @param x The input unsigned integer
   * @return The input value as a 64-bit unsigned integer
   */
  ...
  /**
   * @notice Convert an unsigned integer to a 160-bit unsigned integer
   * @dev Requires the input to be within the valid range for a 160-bit unsigned integer
   * @param x The input unsigned integer
   * @return The input value as a 160-bit unsigned integer
   */
  ...
  /**
   * @notice Convert an unsigned integer to a 192-bit unsigned integer
   * @dev Requires the input to be within the valid range for a 192-bit unsigned integer
   * @param x The input unsigned integer
   * @return The input value as a 192-bit unsigned integer
   */
  ...
  /**
   * @notice Convert an unsigned integer to a 224-bit unsigned integer
   * @dev Requires the input to be within the valid range for a 224-bit unsigned integer
   * @param x The input unsigned integer
   * @return The input value as a 224-bit unsigned integer
   */
  ...
  /**
   * @notice Convert an unsigned integer to a 256-bit unsigned integer
   * @dev Requires the input to be within the valid range for a 256-bit unsigned integer
   * @param x The input integer
   * @return The input value as a 256-bit unsigned integer
   */
