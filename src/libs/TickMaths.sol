...
/**
 * @title Math library forked from Uniswap V3, used for computing sqrt prices from ticks and vice versa
...
library TickMaths {
  ...
  function getSqrtRatioAtTick(
    ...
    // require(absTick <= uint256(_MAX_TICK), 'T'); // TODO need convert int24 to uint256
  ...
  function getTickAtSqrtRatio(
    ...
    require(
      sqrtPriceX96 >= _MIN_SQRT_RATIO && sqrtPriceX96 < _MAX_SQRT_RATIO,
      "R"
    );
