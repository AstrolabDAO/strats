...
import "../external/Chainlink/IChainlink.sol";
 ...
 *
 * @title ChainlinkProvider - Chainlink Network oracles adapter
 * @author Astrolab DAO
...
contract ChainlinkProvider is PriceProvider {
  ...
  function _toUsdBp(
    ...
    if (address(feed) == address(0)) { // unknown asset
  ...
  /**
   * @notice Updates the Chainlink feeds
