...
export const suite: Partial<IFlow>[] = [
  ...
  { fn: deposit, params: [1000], assert: (n: BigNumber) => n.gt(0) }, // deposit
  ...
  // { fn: updateAsset, revertState: true, params: [tokenAddress.USDCe], assert: (n: BigNumber) => n.gt(0) }, // partial redeem
  { fn: shuffleInputs, revertState: true, params: [[4500,0], false], assert: (n: BigNumber) => n.gt(0) }, // partial redeem
